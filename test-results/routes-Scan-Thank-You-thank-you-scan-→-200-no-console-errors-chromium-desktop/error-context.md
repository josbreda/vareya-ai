...
- Name: routes.spec.ts >> Scan Thank You (/thank-you/scan/) → 200, no console errors
- Location: tests\routes.spec.ts:23:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/thank-you/scan/
Call log:
  - navigating to "http://localhost:3000/thank-you/scan/", waiting until "load"
