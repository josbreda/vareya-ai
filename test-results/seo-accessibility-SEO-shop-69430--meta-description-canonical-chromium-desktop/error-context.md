...
- Name: seo-accessibility.spec.ts >> SEO >> /shopify-fulfilment-europe/: has title, meta description, canonical
- Location: tests\seo-accessibility.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/shopify-fulfilment-europe/
Call log:
  - navigating to "http://localhost:3000/shopify-fulfilment-europe/", waiting until "load"
