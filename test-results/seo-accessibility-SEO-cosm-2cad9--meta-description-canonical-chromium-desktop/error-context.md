...
- Name: seo-accessibility.spec.ts >> SEO >> /cosmetics-supplements-fulfilment-europe/: has title, meta description, canonical
- Location: tests\seo-accessibility.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/cosmetics-supplements-fulfilment-europe/
Call log:
  - navigating to "http://localhost:3000/cosmetics-supplements-fulfilment-europe/", waiting until "load"
