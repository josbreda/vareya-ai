...
- Name: seo-accessibility.spec.ts >> SEO >> /eu-fulfilment/: has title, meta description, canonical
- Location: tests\seo-accessibility.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/eu-fulfilment/
Call log:
  - navigating to "http://localhost:3000/eu-fulfilment/", waiting until "load"
