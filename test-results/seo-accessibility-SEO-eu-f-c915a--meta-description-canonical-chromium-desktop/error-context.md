...
- Name: seo-accessibility.spec.ts >> SEO >> /eu-fulfilment-us-brands/: has title, meta description, canonical
- Location: tests\seo-accessibility.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/eu-fulfilment-us-brands/
Call log:
  - navigating to "http://localhost:3000/eu-fulfilment-us-brands/", waiting until "load"
