...
- Name: seo-accessibility.spec.ts >> SEO >> /request-fulfilment-quote/: has title, meta description, canonical
- Location: tests\seo-accessibility.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/request-fulfilment-quote/
Call log:
  - navigating to "http://localhost:3000/request-fulfilment-quote/", waiting until "load"
