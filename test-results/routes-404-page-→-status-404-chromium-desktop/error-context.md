...
- Name: routes.spec.ts >> 404 page → status 404
- Location: tests\routes.spec.ts:41:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://localhost:3000/nonexistent-page-12345
Call log:
  - navigating to "http://localhost:3000/nonexistent-page-12345", waiting until "load"
