...
const ROUTE = "/european-returns-handling-for-turkey-brands/";

export const metadata: Metadata = {
  title: "European Returns Handling for Turkey Brands | Vareya",
  description: "How returns handling works within Vareya's fulfilment service for Turkey brands selling to European customers: where returns land, what must be agreed up front, and the Free Rate Scan.",
  alternates: { canonical: "https://vareya.ai/european-returns-handling-for-turkey-brands/" },
  openGraph: {
    title: "European Returns Handling for Turkey Brands | Vareya",
    description: "How returns handling works within Vareya's fulfilment service for Turkey brands selling to European customers: where returns land, what must be agreed up front, and the Free Rate Scan.",
    url: "https://vareya.ai/european-returns-handling-for-turkey-brands/",
    type: "website",
    locale: "en_GB",
  },
};
