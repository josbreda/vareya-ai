...
const ROUTE = "/shopify-fulfilment-europe-for-china-stores/";

export const metadata: Metadata = {
  title: "Shopify Fulfilment in Europe for China Stores | Vareya",
  description: "How China Shopify stores connect orders to a warehouse in Breda, the Netherlands: order sync, SKU and stock preparation, pick and pack, carrier hand-off, tracking, returns and the Free Rate Scan.",
  alternates: { canonical: "https://vareya.ai/shopify-fulfilment-europe-for-china-stores/" },
  openGraph: {
    title: "Shopify Fulfilment in Europe for China Stores | Vareya",
    description: "How China Shopify stores connect orders to a warehouse in Breda, the Netherlands: order sync, SKU and stock preparation, pick and pack, carrier hand-off, tracking, returns and the Free Rate Scan.",
    url: "https://vareya.ai/shopify-fulfilment-europe-for-china-stores/",
    type: "website",
    locale: "en_GB",
  },
};
