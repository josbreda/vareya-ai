...
export const metadata: Metadata = {
  title: "EU Fulfilment for US Ecommerce Brands | Vareya",
  description:
    "How US ecommerce brands can assess EU-based fulfilment from a Netherlands warehouse for shipping to European customers.",
  alternates: {
...
const PROCESS = [
  {
    title: "Qualification",
    body: "Share your current US-based setup, EU order volume and product category.",
  },
  {
    title: "Onboarding",
  ...
  {
    title: "Inbound stock",
    body: "Send stock from the US, or an existing EU location, to Breda.",
  },
  {
    title: "Fulfilment",
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "This depends on your order volume and markets. Product fit is confirmed during qualification.",
  },
  {
      ...
      <section className="bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white">
        <div className="container-site py-20 sm:py-24">
          <nav aria-label="Breadcrumb" className="mb-8 text-sm text-white/75">
            ...
            <span aria-current="page">EU fulfilment for US brands</span>
          </nav>
      ...
      <section className="border-b border-slate-200 bg-slate-50 py-12" aria-labelledby="quick-answer">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-3 leading-7 text-muted">
            <p>
              US ecommerce brands selling into Europe sometimes assess whether holding
              inventory closer to EU customers is operationally relevant. Vareya fulfils
              orders from a warehouse in Breda, the Netherlands, shipping across Europe
      ...
      <section className="py-16 sm:py-20" aria-labelledby="why-eu-fulfilment">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-4 leading-8 text-muted sm:text-lg">
            <p>
              US brands selling into European markets sometimes find that shipping every
              order individually from the United States adds distance and time compared
              with holding stock closer to those customers. Whether inventory based in
              Europe is relevant depends on the operation being assessed.
            </p>
