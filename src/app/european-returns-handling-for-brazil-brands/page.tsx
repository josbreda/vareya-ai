...
const ROUTE = "/european-returns-handling-for-brazil-brands/";

export const metadata: Metadata = {
  title: "European Returns Handling for Brazil Brands | Vareya",
  description: "How returns handling works within Vareya's fulfilment service for Brazil brands selling to European customers: where returns land, what must be agreed up front, and the Free Rate Scan.",
  alternates: { canonical: "https://vareya.ai/european-returns-handling-for-brazil-brands/" },
  openGraph: {
    title: "European Returns Handling for Brazil Brands | Vareya",
    description: "How returns handling works within Vareya's fulfilment service for Brazil brands selling to European customers: where returns land, what must be agreed up front, and the Free Rate Scan.",
    url: "https://vareya.ai/european-returns-handling-for-brazil-brands/",
    type: "website",
    locale: "en_GB",
  },
};
